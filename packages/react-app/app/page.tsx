    ...
    case "walletconnect":
      return (
        <svg viewBox="0 0 40 40" className={iconClass}>
          <path
            d="M12 15C15.9 11.1 24.1 11.1 28 15L31 12C25.8 6.8 14.2 6.8 9 12L12 15Z"
            fill="#3B99FC"
          />
          <path
            d="M32 20C29.8 17.8 26.4 17.8 24.2 20C22 22.2 22 25.6 24.2 27.8L26.8 30.4C23.3 33.9 16.7 33.9 13.2 30.4L8 25.2L10.8 22.4L16 27.6C17.6 29.2 20.4 29.2 22 27.6C23.6 26 23.6 23.2 22 21.6C20.4 20 17.6 20 16 21.6L13.2 24.4C15.4 26.6 18.8 26.6 21 24.4C23.2 22.2 23.2 18.8 21 16.6C18.8 14.4 15.4 14.4 13.2 16.6L10.6 19.2C14.1 15.7 20.7 15.7 24.2 19.2L27 16.4L32 20Z"
            fill="#3B99FC"
          />
        </svg>
      );
...
export default function Home() {
  ...
  return (
    <div className="w-full h-full flex items-center justify-center p-4 bg-gradient-to-br from-indigo-50 via-blue-50 to-purple-50">
      {/* Only show the white container when NOT connected */}
      {!isConnected || !address ? (
        <motion.div
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {uniqueConnectors.map((connector) => (
              ...
              >
                ...
                >
                  <div
                    className={`absolute inset-0 ${getConnectorGradient(
                      connector.name
                    )} opacity-70 z-0`}
                  />
        ...
        // When connected, show only the loader without the white container
